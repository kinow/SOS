...
import org.n52.sos.config.rasdaman.entities.AdminUser;
import org.n52.sos.config.rasdaman.entities.Binding;
import org.n52.sos.config.rasdaman.entities.BooleanSettingValue;
import org.n52.sos.config.rasdaman.entities.CapabilitiesExtensionImpl;
import org.n52.sos.config.rasdaman.entities.FileSettingValue;
import org.n52.sos.config.rasdaman.entities.IntegerSettingValue;
import org.n52.sos.config.rasdaman.entities.NumericSettingValue;
import org.n52.sos.config.rasdaman.entities.ObservationEncoding;
import org.n52.sos.config.rasdaman.entities.OfferingExtensionImpl;
import org.n52.sos.config.rasdaman.entities.Operation;
import org.n52.sos.config.rasdaman.entities.ProcedureEncoding;
import org.n52.sos.config.rasdaman.entities.StaticCapabilitiesImpl;
import org.n52.sos.config.rasdaman.entities.StringSettingValue;
import org.n52.sos.config.rasdaman.entities.UriSettingValue;
 ...
 */
public class RasdamanSessionFactory extends AbstractSessionFactoryProvider {

    private static final Logger LOG = LoggerFactory.getLogger(RasdamanSessionFactory.class);
    ...
    private static final String RASDAMAN_HIBERNATE_DIALECT = HSQLDialect.class.getName();

    private static final String UPDATE_SCHEMA_VALUE = "update";

    private static final String SQLITE_JDBC_DRIVER = "org.hsqldb.jdbc.JDBCDriver";
    ...
    private SessionFactory createSessionFactory(Properties properties) {
        ...
        cfg.registerTypeOverride(new HibernateGeometryType(), new String[] { "geometry", Geometry.class.getName() });
